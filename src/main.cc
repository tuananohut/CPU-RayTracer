...
{  
  ...
  auto checker = make_shared<checker_texture>(0.32, color(0.847, 0.106, 0.376), color(0, 0.2, 0.4));
...
void cornell_sphere()
{
  ...
  world.add(make_shared<sphere>(point3(300, 150, 300), 100, sphere_material));
  world.add(make_shared<sphere>(point3(100, 100, 300), 50, sphere_material));
